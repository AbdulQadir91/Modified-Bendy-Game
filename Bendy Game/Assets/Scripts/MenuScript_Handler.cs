...
public class MenuScript_Handler : MonoBehaviour
{
	...
	public GameObject removeAdsButton,unlockAllButton,unlockNextLevelRewardedButton,inAppSheet,restoreButton,exitDialoug;
...
//		}
		AdsManagerHandler.adsManager.bestPerformance ();
...
//		#endif
	...
	public void callPP()
	{
		AdsManagerHandler.adsManager.privacyPolicy ();
	}
